...
from contracts.utils.IRemixExampleContract import (
    IRemixExampleContract)
...
func mint{
    ...
    ERC721_mint(to, next_token_id_uint)

    return ()
end

@external
func mint_from_remix{
        pedersen_ptr: HashBuiltin*,
        syscall_ptr: felt*,
        range_check_ptr
    }(to: felt):
    # Check caller is the remix dummy contract
